...
- Instalar/autenticar `gh` en el servidor y probar la instalación `-multi` completa en la VM clonada (Pendientes #6-7), revisando qué repos de OCA quedan omitidos para la rama `19.0`.
